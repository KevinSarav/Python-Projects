...
name1 = input(stringName)                                   #take input to give every individual a name
name2 = input(stringName)
name3 = input(stringName)
name4 = input(stringName)
name5 = input(stringName)

bill1 = input("\n" + stringBill + name2 + ": ")             #take input to give every bill an amount for their specific person
bill2 = input(stringBill + name2 + ": ")
bill3 = input(stringBill + name3 + ": ")
bill4 = input(stringBill + name4 + ": ")
bill5 = input(stringBill + name5 + ": ")
